...
///In the [NarrowView] the UI is displayed as a Column with the user input at the top and the output at the bottom
                  ...
                  children: [
                    ...
                    ActionButtons(
                      clearFunction: () {
                        setState(
                          () {
                            ///clears all values and updates the page with the null values
                            clearSelection();
                            resistance = setAndGetResistance();
                          },
                        );
